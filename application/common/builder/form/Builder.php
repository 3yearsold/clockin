...
class Builder extends ZBuilder
{
     ...
     * @param string $radius marker半径
     * @param string $extra_class 额外css类名
     * @author Mr.cc
     * @return mixed
     */
    public function addBmap($name = '', $title = '', $ak = '', $tips = '', $default = '', $address = '', $level = '',$radius = '', $extra_class = '')
    {
        $item = [
            'type'        => 'bmap',
            'name'        => $name,
                ...
                if ($item['type'] == 'group') {
                        ...
                        foreach ($group as $key => $value) {
                            ...
                            switch ($value['type']) {
                                ...
                                case 'bmap':
                                    ...
                                    $group[$key]['radius']  = $this->_vars['form_data'][$value['name'].'_radius'];
                                default:
                                    if (isset($this->_vars['form_data'][$value['name']])) {
                                        $group[$key]['value'] = $this->_vars['form_data'][$value['name']];
                                    } else {
                    ...
                    switch ($item['type']) {
                        ...
                        case 'bmap':
                            ...
                            $item['radius']  = $this->_vars['form_data'][$item['name'].'_radius'];
                        default:
                            if (isset($this->_vars['form_data'][$item['name']])) {
                                $item['value'] = $this->_vars['form_data'][$item['name']];
                            } else {
